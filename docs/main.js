...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2($author$project$Main$NotStarted, $elm$core$Platform$Cmd$none);
};
...
var $author$project$Shape$Empty = {$: 'Empty'};
var $author$project$Shape$Full = {$: 'Full'};
var $author$project$Shape$fromChar = function (c) {
	return _Utils_eq(
		c,
		_Utils_chr('X')) ? $author$project$Shape$Full : $author$project$Shape$Empty;
};
var $elm$core$String$foldr = _String_foldr;
var $elm$core$String$toList = function (string) {
	return A3($elm$core$String$foldr, $elm$core$List$cons, _List_Nil, string);
};
var $author$project$Shape$fromStringRepresentation = function (lines) {
	return A2(
		$elm$core$List$map,
		A2(
...
var $author$project$Tetromino$moveTetrominoDown = function (_v0) {
	var shape = _v0.a;
	var _v1 = _v0.b;
	var i = _v1.a;
	var j = _v1.b;
...
var $author$project$Tetromino$moveTetrominoLeft = function (_v0) {
	var shape = _v0.a;
	var _v1 = _v0.b;
	var i = _v1.a;
	var j = _v1.b;
...
var $author$project$Tetromino$moveTetrominoRight = function (_v0) {
	var shape = _v0.a;
	var _v1 = _v0.b;
	var i = _v1.a;
	var j = _v1.b;
...
var $author$project$Shape$innerShapeRotateCounterClockWise = function (shape) {
	var tails = A2(
		...
		shape);
	var heads = $elm$core$List$concat(
		A2(
			$elm$core$List$map,
...
var $author$project$Shape$rotateShapeClockWise = function (shape) {
	var tails = A2(
		...
		$elm$core$List$drop(1),
		shape);
	var heads = $elm$core$List$reverse(
...
var $author$project$Tetromino$rotateTetrominoRight = function (_v0) {
	...
	return A2(
		$author$project$Tetromino$Tetromino,
		$author$project$Shape$rotateClockWise(shape),
		_Utils_Tuple2(i, j));
};
...
var $author$project$Grid$removeFullRows = F3(
	function (previous, _new, numberOfRemovedLines) {
		...
		if (!previous.b) {
			return _Utils_Tuple2(_new, numberOfRemovedLines);
		} else {
			if (!previous.b.b) {
				var head = previous.a;
				return A2(cleanRow, head, _List_Nil);
			} else {
				var head = previous.a;
				var rest = previous.b;
				return A2(cleanRow, head, rest);
			}
		}
	});
...
var $author$project$Shape$randomShapeGenerator = function (possibleShapes) {
	return $elm_community$random_extra$Random$List$choose(possibleShapes);
};
var $author$project$Main$applyGameLoop = function (tetris) {
	var _v0 = $author$project$Tetris$makePieceFallDown(tetris);
	if (_v0.b.$ === 'SpawnRandomShape') {
		var updatedTetris = _v0.a;
		var availableShapes = _v0.b.a;
		return _Utils_Tuple2(
			updatedTetris,
			A2(
				$elm$random$Random$generate,
				$author$project$Main$SpawnTetromino,
				$author$project$Shape$randomShapeGenerator(availableShapes)));
	} else {
		var updatedTetris = _v0.a;
...
var $author$project$Tetromino$Rotate = function (a) {
	return {$: 'Rotate', a: a};
};
var $author$project$Tetromino$RotateLeft = {$: 'RotateLeft'};
var $author$project$Tetromino$RotateRight = {$: 'RotateRight'};
...
var $author$project$Main$keyToTetrisCommand = function (rawKey) {
	var _v0 = $ohanhi$keyboard$Keyboard$anyKeyOriginal(rawKey);
	_v0$7:
	while (true) {
		if (_v0.$ === 'Just') {
			switch (_v0.a.$) {
				...
				case 'ArrowLeft':
					var _v2 = _v0.a;
					return $elm$core$Maybe$Just(
						$author$project$Tetromino$Move($author$project$Tetromino$MoveLeft));
				case 'ArrowRight':
					var _v3 = _v0.a;
					return $elm$core$Maybe$Just(
						$author$project$Tetromino$Move($author$project$Tetromino$MoveRight));
				case 'ArrowUp':
					var _v4 = _v0.a;
					return $elm$core$Maybe$Just(
				...
				case 'Alt':
					var _v5 = _v0.a;
					return $elm$core$Maybe$Just(
						$author$project$Tetromino$Rotate($author$project$Tetromino$RotateLeft));
				case 'Control':
					var _v6 = _v0.a;
					return $elm$core$Maybe$Just(
						$author$project$Tetromino$Rotate($author$project$Tetromino$RotateRight));
...
var $author$project$Main$applyKeyPress = F2(
	function (tetris, rawkey) {
		...
		if (msg.$ === 'StartGame') {
			return _Utils_Tuple2(
				...
				A2(
					$elm$random$Random$generate,
					$author$project$Main$SpawnTetromino,
					$author$project$Shape$randomShapeGenerator($author$project$Shape$allShapes)));
		} else {
			switch (model.$) {
				case 'NotStarted':
					...
					switch (msg.$) {
						...
						default:
							if (msg.a.a.$ === 'Nothing') {
								...
								var _v5 = msg.a;
								var shape = _v5.a.a;
								var availableShapes = _v5.b;
								return A3($author$project$Main$spawnTetromino, shape, availableShapes, tetris);
							}
					}
			}
		}
...
var $author$project$Main$btn = A2(
	...
	_List_fromArray(
		[
			...
			$rtfeldman$elm_css$Css$hex('44c767')),
			A2(
			...
			$rtfeldman$elm_css$Css$hex('18ab29')),
			...
			$rtfeldman$elm_css$Css$px(1),
			$rtfeldman$elm_css$Css$px(0),
			$rtfeldman$elm_css$Css$hex('2f6627')),
			$rtfeldman$elm_css$Css$hover(
			_List_fromArray(
				[
					$rtfeldman$elm_css$Css$backgroundColor(
					$rtfeldman$elm_css$Css$hex('5cbf2a'))
				])),
...
var $author$project$Main$buildRow = function (row) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
...
var $author$project$Main$displayGrid = function (grid) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
				...
				_List_fromArray(
					[
						...
						$rtfeldman$elm_css$Css$px(0),
						$rtfeldman$elm_css$Css$px(0),
						$rtfeldman$elm_css$Css$hex('899599')),
						$rtfeldman$elm_css$Css$backgroundColor(
						...
						$rtfeldman$elm_css$Css$px(1),
						$rtfeldman$elm_css$Css$solid,
						$rtfeldman$elm_css$Css$hex('d6bcd6'))
					]))
			]),
		A2(
			$elm$core$List$map,
...
var $author$project$Main$displayScore = function (scoring) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_Nil,
		_List_fromArray(
...
var $author$project$Main$buildTetris = F2(
	function (title, tetris) {
		return A2(
			$rtfeldman$elm_css$Html$Styled$div,
			_List_fromArray(
				[
...
var $author$project$Main$buildGame = function (model) {
	switch (model.$) {
		case 'NotStarted':
			return A2(
				$author$project$Main$btn,
		...
		case 'GameOver':
			var tetris = model.a;
			return A2($author$project$Main$buildTetris, 'Game Over', tetris);
		default:
			var tetris = model.a;
			return A2($author$project$Main$buildTetris, 'Running', tetris);
	}
};
var $rtfeldman$elm_css$Css$paddingTop = $rtfeldman$elm_css$Css$prop1('padding-top');
var $author$project$Main$buildPage = function (model) {
	return A2(
		$rtfeldman$elm_css$Html$Styled$div,
		_List_fromArray(
			[
		...
		_List_fromArray(
			[
				$author$project$Main$buildGame(model)
			]));
};
	...
	return {
		body: $elm$core$List$singleton(
			$rtfeldman$elm_css$Html$Styled$toUnstyled(
				$author$project$Main$buildPage(model))),
